...
class Migration1726200000AddPreOrderCustomFields extends MigrationStep
{
    ...
    {
        // 1. Set anlegen falls noch nicht existent
        $setId = $connection->fetchOne("SELECT `id` FROM `custom_field_set` WHERE `name` = 'custom_preorder_set'");
        if (!$setId) {
